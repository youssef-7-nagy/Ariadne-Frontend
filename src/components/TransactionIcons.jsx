...
export const CreditCardIcon = ({ clientName }) => (
  <div className="card-icon-wrapper" style={{ width: '43.2px', height: '27.7px', position: 'relative' }}>
    <div style={{ transform: 'scale(0.18)', transformOrigin: 'top left', position: 'absolute', top: 0, left: 0 }}>
      <div className="flip-card">
          <div className="flip-card-inner">
              <div className="flip-card-front">
                  ...
                  <p className="name" style={{ textTransform: 'uppercase' }}>{clientName ? clientName.substring(0, 15) : 'CLIENT NAME'}</p>
              </div>
          </div>
      </div>
    </div>
