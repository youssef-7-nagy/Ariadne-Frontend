...
const TEAM_MEMBERS = [
    ...
    },
    {
        ...
        role: 'Marketing & PR',
        badge: 'BRAND & PR',
        bio: 'Bringing together PR, communications, client relations, and account management to turn ideas into impactful work. Working closely with clients and production teams to keep communication clear, relationships strong, and projects moving smoothly.',
        img: imgMaria,
        accentColor: '#8b5cf6',
        icon: FaBullhorn,
    ...
    },
    {
        ...
        role: 'Sound Engineer',
        badge: 'SOUND DEPT',
        bio: 'Leads the audio engineering department, overseeing sound design, mixing, and mastering across all visual formats. His technical expertise in audio post-production ensures clear, immersive soundscapes and a balanced final mix that complements and elevates the visual narrative.',
        img: imgPierre,
        accentColor: '#1392d6',
        icon: GiSoundWaves,
